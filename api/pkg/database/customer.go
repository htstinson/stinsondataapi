...
func (d *Database) CreateCustomer(ctx context.Context, customer *model.Customer, subscriber *model.Subscriber) (*model.Customer, error) {
	...
	fmt.Println("profile.Id", subscriber.Profile.Id)
